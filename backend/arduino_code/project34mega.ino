...
void printReceipt(String data) {
  ...
  printer.print("Datum: ");
  printer.println("30/05/2024   Tijd: 12:40");  // You can update the date and time dynamically
  printer.println("Kaart: xxxxxxxxxxxxx1234");
  printer.justify('C');
  printer.println("--------------------------------");
  printer.setSize('M');
  ...
  printer.println(amount);// You can update the transaction ID dynamically
  printer.feed(4);
}
